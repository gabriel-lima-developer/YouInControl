  ...
  return (
    <>
          ...
          {editing ? (
            <div className="mb-1 flex items-center gap-2">
              ...
              <button
                ...
                disabled={isBusy}
                className="rounded-lg p-1.5 text-primary transition-all hover:bg-primary/10 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100"
              ...
              <button
                ...
                disabled={isBusy}
                className="rounded-lg p-1.5 text-muted-foreground transition-all hover:bg-secondary active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100"
        ...
        <div className="flex items-center justify-between border-t border-border bg-secondary/30 px-4 py-2.5">
          <div className="flex items-center gap-1">
            <button
              ...
              disabled={isBusy}
              className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs text-muted-foreground transition-all hover:bg-secondary hover:text-foreground active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100"
            ...
            <button
              ...
              disabled={isBusy}
              className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs text-muted-foreground transition-all hover:bg-destructive/10 hover:text-destructive active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:scale-100"
      ...
      <ConfirmDialog
        open={confirmOpen}
        title="Excluir lista"
        description={`Tem certeza que deseja excluir a lista "${list.name}"? Todos os itens serao removidos permanentemente.`}
